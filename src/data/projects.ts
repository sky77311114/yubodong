...
export const PROJECT_SHOWCASE: ProjectShowcaseListItem[] = [
  {
    ...
    image: {
      LIGHT: "/images/projects/openparachute.png",
      DARK: "/images/projects/openparachute.png",
    },
  },
  {
    index: 1,
    ...
    image: {
      LIGHT: "/images/projects/musiqmesh.png",
      DARK: "/images/projects/musiqmesh.png",
    },
  },
  {
    index: 2,
    ...
    href: "/projects",
    tags: [
      { name: "Magento2", icon: SiMagento },
      { name: "WooCommerce", icon: SiWoocommerce },
      { name: "PrestaShop", icon: SiPrestashop },
      { name: "OpenCart", icon: OpenCartSvg },
      { name: "NopCommerce", icon: SiPrestashop },
      { name: "Svelte", icon: SiSvelte },
      { name: "TailwindCSS", icon: SiTailwindcss },
    ],
    image: {
      LIGHT: "/images/projects/two.png",
      DARK: "/images/projects/two.png",
    },
  },
];
